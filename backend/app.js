...
app.use(
  cors({
    origin: ['https://we-designe-tees.vercel.app','https://we-designe-tees.vercel.app/dashboard','https://we-designe-tees.vercel.app/profile',] ,// use your actual domain name (or localhost), using * is not recommended
