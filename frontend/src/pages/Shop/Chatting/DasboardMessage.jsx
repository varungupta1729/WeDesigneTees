...
<div className="chat-list-wrapper">
  <div className="chat-list-header" >
    Conversations <span className="c-number">{conversationLength}</span>
    <svg
...
const MessageList = ({
  ...
  return (
    ...
    <li className={`relative chat-list-item ${active === index ? "active" : ""}`}    onClick={(e) =>
        setActive(index) ||
        handleClick(data?._id) ||
        setCurrentChat(data) ||
        setUserData(user) ||
  ...
  return (
   ...
   <div className="app-main">
                ...
                <div>
                  <div
                    className={`w-max max-w-52  mx-auto  h-auto p-2 rounded  ${
                      item.sender === sellerId ? "bg-[#000] text-[#fff]" : "bg-[#ffffff] text-[#000]"
                    }  h-min`}
                  >   
      ...
      <form className="chat-input-wrapper " onSubmit={sendMessageHandler}>
         ...
         <label htmlFor="send">  <button className="chat-send-btn">Send</button></label>
