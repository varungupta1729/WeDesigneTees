  ...
  return (
    <>
      <div className=" h-[70vh]  hidden lg:block">
        <Carousel>
          <div
            className="flex h-full items-center justify-center bg-red-400 dark:bg-gray-700 dark:text-white bg-no-repeat bg-cover"
            style={{
              backgroundImage:
          ...
          <div
            className="flex h-full items-center justify-center bg-gradient-to-r bg-black text-black bg-no-repeat bg-cover relative  "
            style={{
              backgroundImage:
